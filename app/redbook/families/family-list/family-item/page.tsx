...
const FamilyItem: FunctionComponent<FamilyItemProps> = () => {
  return (
    <main>
      <Container className="flex flex-col gap-[48px]">
        <div className="red-book-nav flex flex-col gap-[8px]">
          ...
          <h3 className="red-book-subnav text-GRAY text-SMALL_TEXT">
            ...
            - <Link href={'/redbook/families/families-list'}>Liliopsida, Monocotyledones</Link> -
            <span className="font-bold text-BLACK"> Salsola botschantzevii</span>`
          </h3>
        </div>

        <Post image="/red-book-1.jpg" text={itemText.text} name="Salsola botschantzevii" />
      </Container>
    </main>
  );
};
